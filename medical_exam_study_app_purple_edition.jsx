...
- number: 1
  category: Kardiologi
  uses_image: false
  question: En 65-årig man med bröstsmärta... Vilket kranskärl?
  options:
    - LCX
    - OM
    - RCA
  ...
  more_information: Inferiort EKG-mönster → RCA oftast.
- number: 2
  category: Endokrinologi
  uses_image: false
  question: Förstahandsbehandling vid nydebuterad typ 2-diabetes?
  options:
    - Metformin
    - Sulfonureider
    - Insulin
  ...
  more_information: Metformin om inga kontraindikationer finns.
`
